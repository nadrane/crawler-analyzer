...
var _fileUploader = __webpack_require__(27);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: "addLog",
    value: function addLog(fileName, jsonLog) {
      this.setState(function (oldState) {
        return _extends({}, oldState, _defineProperty({}, fileName, jsonLog));
      });
    }
  }, {
    key: "render",
    value: function render() {
      return _react2.default.createElement(_fileUploader2.default, { addLog: this.addLog });
    }
  }]);
...
var FileUploader = function (_React$Component) {
  ...
  function FileUploader(props) {
    ...
    _this.handleFileLoad = _this.handleFileLoad.bind(_this);
  ...
  _createClass(FileUploader, [{
    ...
    value: function componentDidMount() {
      _electron.ipcRenderer.addListener("file-loaded", this.fileLoaded);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      _electron.ipcRenderer.removeListener("file-loaded", this.fileLoaded);
    }
  }, {
    key: "handleFileLoad",
    value: function handleFileLoad(e) {
      _electron.ipcRenderer.send("load-file");
    }
  }, {
    key: "fileLoaded",
    value: function fileLoaded(event, logs) {
